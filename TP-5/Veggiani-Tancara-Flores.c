/*Ejercicio 10: Se tiene los datos de dos c�rculos. Estos datos son: el nombre, el punto central y el radio.
Se solicita ingresar N puntos del plano e indicar, para cada punto, el c�rculo al cual el punto es interior, o
si es exterior a ambos c�rculos.
Nota: utilizar TD registro para representar cada c�rculo y cada punto. 
